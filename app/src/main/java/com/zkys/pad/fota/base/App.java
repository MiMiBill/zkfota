...
import com.zkys.pad.fota.http.OkgoUtils;
import com.zkys.pad.fota.util.AppUncaughtExceptionHandler;
...
//开始定位
    ...
    public class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            App.this.latitude = "" + latitude;
            App.this.longitude = "" + longitude;
            App.this.address = addr;
